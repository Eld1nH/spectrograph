...
namespace Spectrograph.Visualizations
{
    public class SpectrumBase
    {
        ...
        protected const int ScaleFactorSqr = 4;
        ...
        protected virtual void UpdateFrequencyMapping()
        {
            ...
            {
                int logIndex = (int)((maxLog - Math.Log((actualResolution + 1) - i, (actualResolution + 1))) * indexCount) + _minimumFrequencyIndex;
